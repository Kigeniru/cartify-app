...
import mangoImg from "../assets/tropical-mango.png";
...
function Mango() {
  ...
  const handleAddToCart = async () => {
    const newProduct = {
      ...
      category: "Leche Flan",
      description:
        "The richness of the leche flan's traditional caramelized sweetness is enhanced by the fruity, slightly tangy notes of mango, creating a perfect balance. The luxurious blend of two beloved Filipino treats, leche flan and mango coming together to create a deliciously tropical experience.",
      image: mangoImg,
      price: 700.0,
      quantity: 1,
    };
  ...
  return (
    <div className={styles["mango-theme"]}>
      <header className={styles["mango-header"]}>
      ...
      <main className={styles["mango-main"]}>
        <div className={styles["product-container"]}>
          <div className={styles["product-image"]}>
            <img src={mangoImg} alt="Leche Flan - Tropical Mango" />
          </div>

          <div className={styles["product-details"]}>
            <div className={styles["category"]}>Leche Flan</div>
            <div className={styles["product-title"]}>Tropical Mango</div>
