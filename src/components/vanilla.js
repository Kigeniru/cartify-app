...
import vanillaImg from "../assets/vanilla-harmony.png";
...
function Vanilla() {
  ...
  const handleAddToCart = async () => {
    const newProduct = {
      ...
      category: "Leche Flan",
      description:
        "Silky-smooth custard dessert infused with the warm, sweet aroma of vanilla.",
      image: vanillaImg,
      price: 700.0,
      quantity: 1,
    };
  ...
  return (
    <div className={styles["vanilla-theme"]}>
      <header className={styles["vanilla-header"]}>
      ...
      <main className={styles["vanilla-main"]}>
        <div className={styles["product-container"]}>
          <div className={styles["product-image"]}>
            <img src={vanillaImg} alt="Leche Flan - Vanilla Harmony" />
          </div>

          <div className={styles["product-details"]}>
            <div className={styles["category"]}>Leche Flan</div>
            <div className={styles["product-title"]}>Vanilla Harmony</div>
            <div className={styles["description"]}>
              Silky-smooth custard dessert infused with the warm, sweet aroma of vanilla. It's a delightful twist on the classic Filipino treat, traditionally made with egg yolks, condensed milk, and evaporated milk.
            </div>
